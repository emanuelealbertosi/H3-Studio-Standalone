...
export default function ChatPanel({
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      const messagePayload = await messageResponse.json() as { messages?: ChatMessage[]; error?: string };
  ...
  async function clearChat() {
    ...
    if (response.ok) { setMessages([]); setNotice("Conversazione cancellata"); }
  }
  ...
  return (
    <section className="chat-panel">
      ...
      <div className="chat-messages">
        {!messages.length && (
          <div className="chat-welcome">
            ...
            <p>Posso ragionare con te oppure avviare direttamente Video H3, immagini Krea, edit Flux.2 Klein e immagini Anima. I render Chat partono con 10s · FAST 8 step · 0.5 MP.</p>
      ...
      <footer className="chat-composer">
        ...
        <small>Invio per mandare · Shift+Invio per andare a capo · max 4 immagini vision / 8 media per azione</small>
      </footer>
