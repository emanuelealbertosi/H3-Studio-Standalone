...
|---|---|---|---|
| H3 Studio originale | `F:\H3-Studio` | Prodotto corrente basato su ComfyUI esterna | `c7e601a`, repository GitHub originale |
...
standalone. Il riferimento sorgente corrente è `c7e601a`. **Non importare ancora
...
ComfyUI è avanzata fino a c7e601a: leggi la coda di integrazione nella sezione 11
