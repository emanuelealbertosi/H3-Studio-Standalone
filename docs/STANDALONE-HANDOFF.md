...
|---|---|---|---|
| H3 Studio originale | `F:\H3-Studio` | Prodotto corrente basato su ComfyUI esterna | `e2b05cb`, repository GitHub originale |
...
standalone. Il riferimento sorgente corrente è `e2b05cb`. **Non importare ancora
...
ComfyUI è avanzata fino a e2b05cb: leggi la coda di integrazione nella sezione 11
